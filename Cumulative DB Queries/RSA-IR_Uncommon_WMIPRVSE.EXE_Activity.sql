...
WHERE 
	...
	[se].[FileName_Target] IN ('powershell.exe','cmd.exe','wmic.exe')
	and sfn.FileName = 'wmiprvse.exe'
	AND se.LaunchArguments_Target NOT LIKE '%\ccm\%'
	AND se.LaunchArguments_Target NOT LIKE '%\ccmcache\%'
	AND se.LaunchArguments_Target NOT LIKE '%C:\BEW-%'