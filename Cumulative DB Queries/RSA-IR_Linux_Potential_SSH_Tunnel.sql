...
where
	(la.LaunchArguments like '% 3389:%:3389'
	OR la.LaunchArguments like '%UserKnownHosts=%/dev/null%'
	OR la.LaunchArguments like '%StrictHostKeyChecking=no%')
	AND la.LaunchArguments NOT LIKE '%xsjjira01%'