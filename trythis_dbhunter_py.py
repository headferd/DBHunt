...
def main():
	...
	if args.ssl:
		if args.user and args.passwd:
			conn = 'DRIVER={};SERVER={};DATABASE={};UID={};PWD={};Encrypt=yes;TrustServerCertificate=YES'.format('{ODBC Driver 17 for SQL Server}', args.server, args.database, args.user, args.passwd)
		else:
			conn = 'DRIVER={};SERVER={};DATABASE={};Trusted_Connection=yes;Encrypt=yes;TrustServerCertificate=YES'.format('{ODBC Driver 17 for SQL Server}', args.server, args.database)
	else:
		if args.user and args.passwd:
